...
public class PhotoActivity extends AppCompatActivity {
    ...
    //criando e inflando as opções do menu e adicionando ao menu de PhotoActivity
    @Override
    ...
    void sharePhoto() {
        Uri photoUri = FileProvider.getUriForFile(PhotoActivity.this, "martins.barbosa.rafael.galeria2.fileprovider", new File(photoPath));
